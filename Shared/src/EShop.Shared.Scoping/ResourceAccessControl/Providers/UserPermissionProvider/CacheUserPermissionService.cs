...
/// </summary>
public class CacheUserPermissionService : IUserPermissionsProvider
{
    ...
    public CacheUserPermissionService(IPermissionCachingService permissionCache, UserPermissionHttpClient userPermissionHttpClient)
    {
