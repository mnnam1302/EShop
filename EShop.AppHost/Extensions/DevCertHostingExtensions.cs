...
public static class DevCertHostingExtensions
{
    ...
    /// </remarks>
    public static IResourceBuilder<TResource> RunWithHttpsDevCerttificate<TResource>(
        ...
        Action<string, string>? onSuccessfulExport = null) where TResource : IResourceWithEnvironment
    {
        ...
        {
            builder.ApplicationBuilder.Eventing.Subscribe<BeforeStartEvent>(async (e, ctk) =>
            {
